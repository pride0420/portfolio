...
public class textController {
	...
	@GetMapping("addtext")
	public String addpporder(String porder,String munch,HttpServletRequest request) {
	...
	public String queryAll() {
		...
		*/
		...
		session.setAttribute("Last2", tex);
		
		k=0;
		//找到要轉的id
		te=textmapper.queryId(7);
		T=new StringBuilder(te.getPorder());
	...
	@GetMapping("Addtext")
	public String addtable(String porder,String munch) {
		text t=new text(porder,munch);
		textmapper.add(t);
